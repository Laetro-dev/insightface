...
def get_model(name, **kwargs):
    root = kwargs.pop("root", "~/.insightface")
    root = os.path.expanduser(root)
    model_root = osp.join(root, "models")
    allow_download = kwargs.pop("download", False)
    download_zip = kwargs.pop("download_zip", False)
    ...
    providers = kwargs.pop("providers", get_default_providers())
    provider_options = kwargs.pop("provider_options", get_default_provider_options())
